...
var stick_xy = [512,-1,0,5];
// var stick_id = Math.floor(Math.random() * 9999).toString().padStart(4,"0"); // Not used yet

/* Events:
	!spos charX tileX - Draws stickman at said X.
  !sb4 charX tileX - Erases stickman at said X, always sent before !spos
